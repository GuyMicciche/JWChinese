...
namespace JWChinese
{
    ...
    /// Class ButtonGroup.
    /// </summary>
    public partial class ChapterGridView : ContentView
    {
        /// <summary>
        /// The outline color property
        /// </summary>
        public static BindableProperty OutlineColorProperty = BindableProperty.Create("OutlineColor", typeof(Color), typeof(LibraryGridView), Color.Default);
        /// <summary>
        /// The view background color property
        /// </summary>
        public static BindableProperty ViewBackgroundColorProperty = BindableProperty.Create("ViewBackgroundColor", typeof(Color), typeof(LibraryGridView), Color.Default);
#pragma warning disable CS0108 // Member hides inherited member; missing new keyword
        /// <summary>
        /// The background color property
        /// </summary>
        public static BindableProperty BackgroundColorProperty = BindableProperty.Create("BackgroundColor", typeof(Color), typeof(LibraryGridView), Color.Default);
#pragma warning restore CS0108 // Member hides inherited member; missing new keyword
        /// <summary>
        /// The selected background color property
        /// </summary>
        public static BindableProperty SelectedBackgroundColorProperty = BindableProperty.Create("SelectedBackgroundColor", typeof(Color), typeof(LibraryGridView), Color.Default);
        /// <summary>
        /// The text color property
        /// </summary>
        public static BindableProperty TextColorProperty = BindableProperty.Create("TextColor", typeof(Color), typeof(LibraryGridView), Color.Default);
        /// <summary>
        /// The selected text color property
        /// </summary>
        public static BindableProperty SelectedTextColorProperty = BindableProperty.Create("SelectedTextColor", typeof(Color), typeof(LibraryGridView), Color.Default);
        /// <summary>
        /// The border color property
        /// </summary>
        public static BindableProperty BorderColorProperty = BindableProperty.Create("BorderColor", typeof(Color), typeof(LibraryGridView), Color.Default);
        /// <summary>
        /// The selected border color property
        /// </summary>
        public static BindableProperty SelectedBorderColorProperty = BindableProperty.Create("SelectedBorderColor", typeof(Color), typeof(LibraryGridView), Color.Black);
        /// <summary>
        /// The selected frame background color property
        /// </summary>
        public static BindableProperty SelectedFrameBackgroundColorProperty = BindableProperty.Create("SelectedFrameBackgroundColor", typeof(Color), typeof(LibraryGridView), Color.Black);
        /// <summary>
        /// The selected index property
        /// </summary>
        public static BindableProperty SelectedIndexProperty = BindableProperty.Create("SelectedIndex", typeof(int), typeof(LibraryGridView), -1, BindingMode.TwoWay);
        /// <summary>
        /// The items property property
        /// </summary>
        public static readonly BindableProperty ItemsSourceProperty = BindableProperty.Create("ItemsSource", typeof(IEnumerable<string>), typeof(LibraryGridView), null, BindingMode.TwoWay, propertyChanged: OnItemsSourceChanged);
        /// <summary>
        /// The font property
        /// </summary>
        public static BindableProperty FontProperty = BindableProperty.Create("Font", typeof(Font), typeof(LibraryGridView), Font.Default);
        /// <summary>
        /// The rounded property
        /// </summary>
        public static BindableProperty RoundedProperty = BindableProperty.Create("Rounded", typeof(bool), typeof(LibraryGridView), false);
        /// <summary>
        /// The is number property
        /// </summary>
        public static BindableProperty IsNumberProperty = BindableProperty.Create("IsNumber", typeof(bool), typeof(LibraryGridView), false);

        //public static BindableProperty SpacingProperty = BindableProperty.Create("Spacing", typeof(int), typeof(LibraryGridView), 2, BindingMode.TwoWay);
        public static BindableProperty ButtonHeightProperty = BindableProperty.Create("ButtonHeight", typeof(int), typeof(LibraryGridView), 0, BindingMode.TwoWay);
        public static BindableProperty ButtonWidthProperty = BindableProperty.Create("ButtonWidth", typeof(int), typeof(LibraryGridView), 0, BindingMode.TwoWay);

        private static void OnItemsSourceChanged(BindableObject bindable, object oldvalue, object newvalue)
        {
            var control = bindable as ChapterGridView;
            if (control == null || newvalue == null) return;
            control._buttonLayout.Children.Clear();
            foreach (var item in (IEnumerable<string>)newvalue)
            {
                control.AddButton(item);
            }
        }

        public static readonly BindableProperty TappedCommandProperty = BindableProperty.Create("TappedCommand", typeof(ICommand), typeof(LibraryGridView), null);
...
#pragma warning restore CS0108 // Member hides inherited member; missing new keyword
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="LibraryGridView"/> is rounded.
        /// </summary>
        ...
        public void AddButton(string text)
        {
            ...
            button.Command = TappedCommand;
            button.CommandParameter = text;

            if (IsNumber)
            {
                button.Text = string.Format("{0}", text);
                if (Device.RuntimePlatform == Device.Android) { button.FontSize = 22; };
