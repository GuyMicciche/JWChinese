...
namespace JWChinese
{
    ...
    {
        event EventHandler OnSwipedUp;
        event EventHandler OnSwipedDown;
        event EventHandler OnSwipedLeft;
        event EventHandler OnSwipedRight;
        ...
        void RaiseOnSwipedUp();
        void RaiseOnSwipedDown();
        void RaiseOnSwipedLeft();
        void RaiseOnSwipedRight();
    }
    ...
    public class GridView : ListView, IScrollAwareElement
    {
        ...
        public static readonly BindableProperty TappedCommandProperty = BindableProperty.CreateAttached("TappedCommand", typeof(ICommand), typeof(GridView), null, propertyChanged: OnTappedCommandPropertyChanged);
        ...
        /// </summary>
        public static readonly BindableProperty MinItemWidthProperty = BindableProperty.Create("MinItemWidth", typeof(double), typeof(GridView), (double)100D);
        ...
        /// The item width property
        /// </summary>
        public static readonly BindableProperty PaddingProperty = BindableProperty.Create("Padding", typeof(double), typeof(GridView), (double)40D);
        ...
        public static void SetPadding(BindableObject view, double value)
        {
        ...
        public event EventHandler OnSwipedUp;
        public event EventHandler OnSwipedDown;
        public event EventHandler OnSwipedLeft;
        public event EventHandler OnSwipedRight;
        ...
        public void RaiseOnSwipedUp()
        {
            OnSwipedUp?.Invoke(this, new EventArgs());
        }

        public void RaiseOnSwipedDown()
        {
            OnSwipedDown?.Invoke(this, new EventArgs());
        }

        public void RaiseOnSwipedLeft()
        {
            OnSwipedLeft?.Invoke(this, new EventArgs());
        }

        public void RaiseOnSwipedRight()
        {
            OnSwipedRight?.Invoke(this, new EventArgs());
        }
