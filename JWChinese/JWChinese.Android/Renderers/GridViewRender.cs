...
using Android.Views;
using FormsGridView = JWChinese.GridView;
...
[assembly: ExportRenderer(typeof(FormsGridView), typeof(GridViewRender))]
namespace JWChinese.Droid
{
    ...
    /// </summary>
    public class GridViewRender : ViewRenderer<FormsGridView, RecyclerView>
    {
        #region Fields

        readonly global::Android.Content.Res.Orientation _orientation = global::Android.Content.Res.Orientation.Undefined;
    ...
    {
        public ScrollRecyclerView(IntPtr javaReference, global::Android.Runtime.JniHandleOwnership transfer) : base(javaReference, transfer)
        {
        }

        public ScrollRecyclerView(global::Android.Content.Context context, global::Android.Util.IAttributeSet attrs, int defStyle) : base(context, attrs, defStyle)
        {
        }
        ...
        public ScrollRecyclerView(global::Android.Content.Context context) : base(context)
        {
        }
