...
[assembly: ExportRenderer (typeof(JWChinese.GridView), typeof(GridViewRender))]
namespace JWChinese.iOS
{
    #region GridViewRender

    /// <summary>
    /// Class GridViewRenderer.
    /// </summary>
    public class GridViewRender : ViewRenderer<GridView, GridCollectionView>, IGridViewProvider
    {
        #region Fields
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<GridView> e)
        {
            ...
            int pad = (int)((double)e.NewElement.GetValue(JWChinese.GridView.PaddingProperty));
            _gridCollectionView.ContentInset = new UIEdgeInsets(0, pad, pad, pad);
            ...
            // THIS HACK DONE BY GUY MICCICHE
            ElementSizeChanged(Element, new EventArgs());
        ...
        private void ElementSizeChanged(object sender, EventArgs e)
        {
            ...
            int pad = (int)((double)gridView.GetValue(JWChinese.GridView.PaddingProperty));

            //Work out how many items can fit.
            var canfit = (int)Math.Max(1, Math.Floor((gridView.Width - pad - pad) / gridView.MinItemWidth));

            //Stretch the width to fill row.
            var actualWidth = (gridView.Width - pad - pad) / canfit;
        ...
        protected override void OnElementPropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            ...
            else if (e.PropertyName == JWChinese.GridView.PaddingProperty.PropertyName)
            {
                var grid = sender as JWChinese.GridView;
	...
	public class GridViewCell : UICollectionViewCell
    {
        ...
        //JWChinese.GridViewCell _viewCell;
        ViewCell _viewCell;
        ...
        //public JWChinese.GridViewCell ViewCell { get { return _viewCell; } }
